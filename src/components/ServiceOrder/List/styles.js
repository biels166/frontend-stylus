...
import { Accordion, Box, Pagination, Paper } from '@mui/material'
import SVG from 'react-inlinesvg'
import JoinFullIcon from '@mui/icons-material/JoinFull';

export const CustomLateIcon = styled(JoinFullIcon)({
    color: '#8B0000'
})

export const CustomAllIcon = styled(JoinFullIcon)({
    color: '#003C73'
})

export const CustomTodayIcon = styled(JoinFullIcon)({
    color: '#FF8C00'
})

export const CustomTomorrowIcon = styled(JoinFullIcon)({
    color: '#008B8B'
})

export const CustomThisWeekIcon = styled(JoinFullIcon)({
    color: '#003C73'
})
