...
import { ModalDeleteQuoteService } from '../ModalDeleteServiceItem'

export const QuoteServiceCard = ({ product, handleDeleteAndReloadList = () => String }) => {
      ...
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} lg={12}>
            <Typography>
              Serviço: <span>{product.product}</span>
            </Typography>
          </Grid>
          <Grid item xs={4} lg={4}>
            <Typography>
