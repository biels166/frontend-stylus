...
export const CustomCancelIcon = styled(CancelIcon)({
    color: '#8B0000'
})
...
export const CustomDraftIcon = styled(EditNoteIcon)({
    color: '#FF8C00'
})

export const CustomPendingIcon = styled(PendingIcon)({
    color: '#003C73'
})

export const CustomApprovedIcon = styled(RecommendIcon)({
    color: '#008B8B'
})
