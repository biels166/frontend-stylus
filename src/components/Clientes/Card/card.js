...
import { CancelButton, CloseIcon, Container, CustomModalBody, CustomModalFooter, CustomModalHeader, CustomModalPaper, CutomEditDetails, IconButtons, IconDiv, NFSButton, SaveButton, ShowMore } from './styles'
