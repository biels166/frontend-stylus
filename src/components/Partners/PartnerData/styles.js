...
export const CustomIcon = styled(SocialDistanceIcon)({
    color: (props) => props.enable ? '#2775A2' : '#A9A9A9',
})

export const CustomPhoneIcon = styled(PhoneIcon)({
    color: (props) => props.enable ? '#2775A2' : '#A9A9A9',
})

export const DetailsIcon = styled(ConnectWithoutContactIcon)({
    color: (props) => props.enable ? '#2775A2' : '#A9A9A9',
})
