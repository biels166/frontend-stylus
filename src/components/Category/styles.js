...
export const CustomCategoryListIcon = styled(ChecklistOutlinedIcon)({
    color: (props) => props.enable ? '#2775A2' : '#A9A9A9',
})

export const CustomItemIcon = styled(FormatListNumberedOutlinedIcon)({
    color: (props) => props.enable ? '#2775A2' : '#A9A9A9',
})

export const CustomCategoryIcon = styled(DeveloperBoardOutlinedIcon)({
    color: (props) => props.enable ? '#2775A2' : '#A9A9A9',
})

export const CustomUPhoneIcon = styled(PhoneIcon)({
    color: (props) => props.enable ? '#2775A2' : '#A9A9A9',
})

export const ClientDetailsIcon = styled(ConnectWithoutContactIcon)({
    color: (props) => props.enable ? '#2775A2' : '#A9A9A9',
})
...
export const NFSIcon = styled(SVG)({
    borderRadius: '8px',
    padding: '5px 5px',
    cursor: 'pointer',
    '&:hover': {
